...
import { Dumbbell, Calendar, LogOut, Bell, Award } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              <Dumbbell className="h-8 w-8 text-blue-700" />
              <h1 className="ml-2 text-2xl font-bold text-gray-900">Academia UFIT</h1>
            </div>
            <button
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Bem-vindo de volta à sua área de aluno. Confira seu progresso e próximos treinos.
          </p>
        </div>
              ...
              <div>
                ...
                {currentUser.nextWorkout ? (
                  <div className="space-y-1">
                    <p className="text-xl font-bold">{currentUser.nextWorkout.type}</p>
                    <p>
                      {currentUser.nextWorkout.date} às {currentUser.nextWorkout.time}
                    </p>
                    <Button
                      variant="outline"
              ...
              <div>
                ...
                <div className="mt-4 h-2 bg-gray-200 rounded-full">
                  <div
                    ...
                    style={{ width: `${Math.min((currentUser.workoutsCompleted / 5) * 100, 100)}%` }}
                  ></div>
                </div>
        ...
        <section className="mt-12">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-xl font-bold text-gray-900">Avisos da Academia</h2>
          </div>
